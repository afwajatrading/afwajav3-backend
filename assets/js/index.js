(function () {
    ...
    const translations = {
        en: {
            ...
            locations_label: "Popular Locations",
            locations_title: "Car rental by location",
            locations_desc: "Choose a key location to view pickup, delivery and suitable car recommendations.",
            locations_cyberjaya_title: "Car Rental Cyberjaya",
            locations_cyberjaya_desc: "Self-pickup in Cyberjaya or delivery around nearby areas.",
            locations_klia_title: "Car Rental KLIA",
            locations_klia_desc: "Suitable for airport pickup, business trips and balik kampung journeys.",
            locations_putrajaya_title: "Car Rental Putrajaya",
            locations_putrajaya_desc: "Convenient for office matters, events, meetings and family trips.",
            locations_view_link: "View location",
            fleet_label: "Our Fleet", fleet_title: "Choose Your Perfect Ride",
            fleet_locations_label: "Popular locations",
            fleet_locations_title: "Find rental cars by area",
            fleet_locations_desc: "Check pickup and delivery details for Cyberjaya, KLIA and Putrajaya.",
            ...
            footer_main_pages: "Main Pages",
            footer_locations_policies: "Locations & Policies",
            footer_copy: "All Rights Reserved.",
            footer_services: "Chauffeur Services",
            footer_driver_transfer: "Driver & Transfer",
            footer_location_cyberjaya: "Car Rental Cyberjaya",
            footer_location_klia: "Car Rental KLIA",
            footer_location_putrajaya: "Car Rental Putrajaya",
            footer_faq: "FAQ",
            footer_price_reference: "Price Reference",
            footer_guide: "Useful Info & Tips",
            ...
            modal_terms_agreement_html: 'I agree to the <a href="terms.html" target="_blank" rel="noopener noreferrer" class="font-semibold text-afwaja-teal underline underline-offset-2 hover:text-afwaja-navy">Terms &amp; Conditions</a> and <a href="refund-policy.html" target="_blank" rel="noopener noreferrer" class="font-semibold text-afwaja-teal underline underline-offset-2 hover:text-afwaja-navy">Refund Policy</a> before proceeding to BayarCash.',
            modal_cancel: "Cancel",
        ...
        ms: {
            ...
            locations_label: "Kawasan Popular",
            locations_title: "Kereta sewa mengikut lokasi",
            locations_desc: "Pilih lokasi utama untuk lihat maklumat pickup, delivery dan cadangan kereta yang sesuai.",
            locations_cyberjaya_title: "Kereta Sewa Cyberjaya",
            locations_cyberjaya_desc: "Pickup sendiri di Cyberjaya atau delivery ke kawasan sekitar.",
            locations_klia_title: "Kereta Sewa KLIA",
            locations_klia_desc: "Sesuai untuk airport pickup, business trip dan perjalanan balik kampung.",
            locations_putrajaya_title: "Kereta Sewa Putrajaya",
            locations_putrajaya_desc: "Mudah untuk urusan pejabat, event, mesyuarat dan keluarga.",
            locations_view_link: "Lihat lokasi",
            fleet_label: "Kereta Kami", fleet_title: "Pilih Kereta Idaman Anda",
            fleet_locations_label: "Lokasi popular",
            fleet_locations_title: "Cari kereta sewa ikut kawasan",
            fleet_locations_desc: "Semak maklumat pickup dan delivery untuk Cyberjaya, KLIA dan Putrajaya.",
            ...
            footer_main_pages: "Laman Utama",
            footer_locations_policies: "Lokasi & Polisi",
            footer_copy: "Hak Cipta Terpelihara.",
            footer_services: "Servis Chauffeur",
            footer_driver_transfer: "Driver & Transfer",
            footer_location_cyberjaya: "Kereta Sewa Cyberjaya",
            footer_location_klia: "Kereta Sewa KLIA",
            footer_location_putrajaya: "Kereta Sewa Putrajaya",
            footer_faq: "FAQ",
            ...
            modal_terms_agreement_html: 'Saya setuju dengan <a href="terms.html" target="_blank" rel="noopener noreferrer" class="font-semibold text-afwaja-teal underline underline-offset-2 hover:text-afwaja-navy">Terma &amp; Syarat</a> dan <a href="refund-policy.html" target="_blank" rel="noopener noreferrer" class="font-semibold text-afwaja-teal underline underline-offset-2 hover:text-afwaja-navy">Polisi Refund</a> sebelum meneruskan ke BayarCash.',
            modal_cancel: "Batal",
